...
# Add your code here
total_cost = 0
for a in actual_insurance_costs:
  total_cost += a
...
updated_estimated_costs = [a*11/10 for a in estimated_insurance_costs]
print(updated_estimated_costs)
#12
a = 0
while a < len(actual_insurance_costs):
  total_cost += actual_insurance_costs[a]
  a += 1
average_cost = total_cost/len(actual_insurance_costs)
